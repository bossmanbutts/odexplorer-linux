...
Status (2026-08-09, TOAST NOTIFICATIONS + STARTUP RESUME + SETTINGS PERSISTENCE + BIO-DISCOVERY TOASTS + EDSM SYSTEM-DETAILS FLOW + FIRST-RUN ONBOARDING SHIPPED):
...
- Remaining for full parity: CartographicView layout polish (Detailed/Classic/Horizontal/Extended), real ODUtils/EliteJournalReader package swap.
