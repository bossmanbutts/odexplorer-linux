// Functional in-memory OrganicCheckListDataStore for the journal→exobiology pipeline.
// Mirrors the real store's checklist state machine (None/Unavailable/Discovered/
// Analysed/Sold) using the embedded ExoData table.
