...
public sealed class Tussock_Pennata : SpeciesBase
{
	public override string Genus => "Tussock";

	public override string SpeciesCodex => "$Codex_Ent_Tussocks_01_Name;";

	public override string SpeciesName => "Pennata";
	...
	public override double MaxPressure => 0.0155;

	public override double MinTemperature => 146.0;

	public override double MaxTemperature => 154.0;
	...
	public override List<Variant> Variants
	{
		get
		{
			...
			int num2 = 0;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_M_Name;", "Tussock Pennata - Emerald", VariantColours.Emerald, StarType.M, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_K_Name;", "Tussock Pennata - Green", VariantColours.Green, StarType.K, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_G_Name;", "Tussock Pennata - Lime", VariantColours.Lime, StarType.G, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_D_Name;", "Tussock Pennata - Maroon", VariantColours.Maroon, StarType.D, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_W_Name;", "Tussock Pennata - Orange", VariantColours.Orange, StarType.W, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_Y_Name;", "Tussock Pennata - Red", VariantColours.Red, StarType.Y, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_L_Name;", "Tussock Pennata - Sage", VariantColours.Sage, StarType.L, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_T_Name;", "Tussock Pennata - Teal", VariantColours.Teal, StarType.T, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_01_F_Name;", "Tussock Pennata - Yellow", VariantColours.Yellow, StarType.F, PlanetMaterial.None);
			return list;
		}
	}
