...
public sealed class Tussock_Triticum : SpeciesBase
{
	public override string Genus => "Tussock";

	public override string SpeciesCodex => "$Codex_Ent_Tussocks_12_Name;";

	public override string SpeciesName => "Triticum";
	...
	public override double MinTemperature => 191.0;
	...
	public override List<Variant> Variants
	{
		get
		{
			...
			int num2 = 0;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_M_Name;", "Tussock Triticum - Emerald", VariantColours.Emerald, StarType.M, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_K_Name;", "Tussock Triticum - Green", VariantColours.Green, StarType.K, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_G_Name;", "Tussock Triticum - Lime", VariantColours.Lime, StarType.G, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_D_Name;", "Tussock Triticum - Maroon", VariantColours.Maroon, StarType.D, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_W_Name;", "Tussock Triticum - Orange", VariantColours.Orange, StarType.W, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_Y_Name;", "Tussock Triticum - Red", VariantColours.Red, StarType.Y, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_L_Name;", "Tussock Triticum - Sage", VariantColours.Sage, StarType.L, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_T_Name;", "Tussock Triticum - Teal", VariantColours.Teal, StarType.T, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_12_F_Name;", "Tussock Triticum - Yellow", VariantColours.Yellow, StarType.F, PlanetMaterial.None);
			return list;
		}
	}
