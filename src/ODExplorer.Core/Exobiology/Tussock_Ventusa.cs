...
public sealed class Tussock_Ventusa : SpeciesBase
{
	public override string Genus => "Tussock";

	public override string SpeciesCodex => "$Codex_Ent_Tussocks_02_Name;";

	public override string SpeciesName => "Ventusa";
	...
	public override double MaxPressure => 0.022;

	public override double MinTemperature => 155.0;

	public override double MaxTemperature => 160.0;
	...
	public override List<Variant> Variants
	{
		get
		{
			...
			int num2 = 0;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_M_Name;", "Tussock Ventusa - Emerald", VariantColours.Emerald, StarType.M, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_K_Name;", "Tussock Ventusa - Green", VariantColours.Green, StarType.K, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_G_Name;", "Tussock Ventusa - Lime", VariantColours.Lime, StarType.G, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_D_Name;", "Tussock Ventusa - Maroon", VariantColours.Maroon, StarType.D, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_W_Name;", "Tussock Ventusa - Orange", VariantColours.Orange, StarType.W, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_Y_Name;", "Tussock Ventusa - Red", VariantColours.Red, StarType.Y, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_L_Name;", "Tussock Ventusa - Sage", VariantColours.Sage, StarType.L, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_T_Name;", "Tussock Ventusa - Teal", VariantColours.Teal, StarType.T, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_02_F_Name;", "Tussock Ventusa - Yellow", VariantColours.Yellow, StarType.F, PlanetMaterial.None);
			return list;
		}
	}
