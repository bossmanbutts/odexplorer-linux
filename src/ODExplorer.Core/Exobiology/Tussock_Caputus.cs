...
public sealed class Tussock_Caputus : SpeciesBase
{
	public override string Genus => "Tussock";

	public override string SpeciesCodex => "$Codex_Ent_Tussocks_11_Name;";

	public override string SpeciesName => "Caputus";
	...
	public override double MinTemperature => 181.0;
	...
	public override List<Variant> Variants
	{
		get
		{
			...
			int num2 = 0;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_M_Name;", "Tussock Caputus - Emerald", VariantColours.Emerald, StarType.M, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_K_Name;", "Tussock Caputus - Green", VariantColours.Green, StarType.K, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_G_Name;", "Tussock Caputus - Lime", VariantColours.Lime, StarType.G, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_D_Name;", "Tussock Caputus - Maroon", VariantColours.Maroon, StarType.D, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_W_Name;", "Tussock Caputus - Orange", VariantColours.Orange, StarType.W, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_Y_Name;", "Tussock Caputus - Red", VariantColours.Red, StarType.Y, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_L_Name;", "Tussock Caputus - Sage", VariantColours.Sage, StarType.L, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_T_Name;", "Tussock Caputus - Teal", VariantColours.Teal, StarType.T, PlanetMaterial.None);
			num2++;
			span[num2] = new Variant("$Codex_Ent_Tussocks_11_F_Name;", "Tussock Caputus - Yellow", VariantColours.Yellow, StarType.F, PlanetMaterial.None);
			return list;
		}
	}
